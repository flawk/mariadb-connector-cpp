...
IF(DEB)
  ...
  SET(INSTALL_LIB_SUFFIX ${CMAKE_INSTALL_LIBDIR}/${CMAKE_LIBRARY_ARCHITECTURE} CACHE PATH "")
ENDIF()

IF(RPM)
  SET(INSTALL_LAYOUT "RPM")
  SET(INSTALL_LIB_SUFFIX ${CMAKE_INSTALL_LIBDIR} CACHE PATH "")
ENDIF()
...
IF(UNIX)
  SET(libmariadb_prefix ${CMAKE_INSTALL_PREFIX} CACHE PATH "")
ENDIF()
